...
enum {
	...
	OPT_FOLLOW     = 0x200,
	OPT_SKIP_OK    = 0x400,
	OPT_IGNORE_CASE = 0x800,
	OPT_VERBOSE    = 0x1000,
	OPT_PERCENTS   = 0x2000,
	OPT_SPEED      = 0x4000,
	OPT_BT_PRIVATE = 0x8000,
	OPT_UPPERCASE  = 0x10000,
	OPT_LOWERCASE  = 0x20000,
	OPT_GOST_REVERSE = 0x40000,
	OPT_BENCH_RAW  = 0x80000,
